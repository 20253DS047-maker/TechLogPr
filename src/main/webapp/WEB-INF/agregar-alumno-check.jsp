    ...
    <div class="card shadow">
        ...
        <div class="card-body text-center">
            ...
            <div class="text-start mt-4">
                <p><strong>Nombre:</strong> ${bitacoraAlumno.nombre}</p>
                <p><strong>Apellido:</strong> ${bitacoraAlumno.apellido}</p>
                <p><strong>Matrícula:</strong> ${bitacoraAlumno.matricula_usuario}</p>
            </div>

            <div class="d-grid gap-20 col-3 mx-auto mb-3">
                <button type="button" onclick="window.location.href='vista-admin-servlet'" class="btn btn-primary">Volver</button>
            </div>
        </div>
