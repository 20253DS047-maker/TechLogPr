...
<div class="container min-vh-100 d-flex flex-column justify-content-center align-items-center position-relative" style="z-index: 2;">
    ...
    <div class="text-center mb-4">
        ...
        <h5 class="fw-normal" style="color: #000;">(DOCENTE)</h5>
    </div>

    <div class="card-formulario">
        <form action="bitacora-docente-servlet" method="post">

            <div class="mb-3">
                <label for="nombre" class="form-label form-label-custom">Nombre:</label>
                <input type="text" class="form-control form-control-custom" id="nombre" name="nombre" placeholder="Ej: Pedro" required>
            </div>

            <div class="mb-3">
                <label for="apellido" class="form-label form-label-custom">Apellido Paterno:</label>
                <input type="text" class="form-control form-control-custom" id="apellido_paterno" name="apellido_paterno" placeholder="Ej: Hurieta" required>
            </div>

            <div class="mb-3">
                <label for="apellido" class="form-label form-label-custom">Apellido Materno:</label>
                <input type="text" class="form-control form-control-custom" id="apellido_materno" name="apellido_materno" placeholder="Ej: Flores" required>
            </div>

            <div class="mb-3">
                <label for="area" class="form-label form-label-custom">Área:</label>
