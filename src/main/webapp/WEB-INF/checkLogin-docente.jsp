...
<head>
    ...
    <title>INICIO DE SESIÓN EXITOSO - DOCENTE</title>
    ...
    <div class="card shadow">
        ...
        <div class="card-body text-center">
            ...
            <div class="d-grid gap-20 col-3 mx-auto mb-3">
                <button type="button" onclick="window.location.href='bitacora-docente-servlet'" class="btn btn-primary">Continuar</button>
            </div>
        </div>
    </div>
</div>
