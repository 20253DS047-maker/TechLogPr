...
<body>
  ...
  <div class="modal-overlay">
    <div class="confirm-box" style="border: 2px solid #1c8a6c;">
      <div class="confirm-text" style="padding-top:24px; font-weight:600;">¿Estas seguro de cerrar sesion?</div>
      <div class="confirm-actions">
        <button class="btn-salir">No</button>
        <button class="btn-confirmar">Si</button>
      </div>
    </div>
  </div>
