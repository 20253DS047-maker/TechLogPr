    ...
    <div class="card-formulario">
        <form action="check-bitacora-servlet" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control form-control-custom" id="nombre" placeholder="Ej: Pedro" required>
            </div>

            <div class="mb-3">
                <label for="apellido" class="form-label form-label-custom">Apellido:</label>
                <input type="text" class="form-control form-control-custom" id="apellido" placeholder="Ej: Hurieta" required>
            </div>
